      ...
      <main className="max-w-7xl mx-auto px-6 py-12 space-y-20">
        ...
        <section className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <StatCard
            ...
            label={t("stats.needsCreated")}
            value={stats.needsCreated.toString()}
          />
          <StatCard
            icon={<TrendingUp className="w-5 h-5" />}
            label={t("stats.needsFunded")}
            value={stats.needsFunded.toString()}
          />
          <StatCard
            icon={<CheckCircle className="w-5 h-5" />}
            label={t("stats.deliveriesConfirmed")}
            value={stats.deliveriesConfirmed.toString()}
          />
          <StatCard
