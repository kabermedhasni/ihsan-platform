    ...
    <div className="bg-secondary/20 backdrop-blur-sm p-6 rounded-3xl border border-white/5 flex flex-col gap-4 group hover:border-primary/20 transition-all hover:bg-secondary/30">
      <div className="flex justify-between items-start">
        <div className="space-y-1">
          <p className="text-[10px] font-black text-primary uppercase tracking-widest text-left rtl:text-right">
            {t("card.orderId", { id: order.id })}
          </p>
          <h3 className="text-lg font-black text-white text-left rtl:text-right">
            {order.type}
          </h3>
        </div>
      ...
      <div className="space-y-3 py-4 border-y border-white/5">
        <div className="flex items-center gap-3 text-emerald-100/60 text-left rtl:text-right">
        ...
        <div className="flex items-center gap-3 text-emerald-100/60 text-left rtl:text-right">
          ...
          <span className="text-sm font-bold">
            {t("card.scheduled", { time: order.scheduledTime })}
          </span>
        </div>
      </div>

      <div className="flex items-center justify-between">
        <div className="bg-white/5 px-4 py-2 rounded-xl border border-white/5 text-left rtl:text-right">
          <p className="text-[10px] font-bold text-muted-foreground lowercase">
            {t("card.target")}
          </p>
          <p className="text-sm font-black text-primary">
            {order.amount} {t("stats.mru")}
          </p>
        </div>
        <button
