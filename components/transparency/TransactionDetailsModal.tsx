...
export const TransactionDetailsModal = ({ tx, onClose }: { tx: Transaction, onClose: () => void }) => (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
        ...
        >
            <button
                onClick={onClose}
                className="absolute top-8 right-8 w-12 h-12 bg-muted rounded-full flex items-center justify-center text-muted-foreground hover:text-foreground transition-all z-20"
            >
                <X className="w-6 h-6" />
            </button>
            ...
            <div className="grid md:grid-cols-2">
                <div className="p-8 md:p-12">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <div>
                            <p className="text-[10px] font-black text-primary uppercase tracking-widest">Transaction Verified</p>
                            <p className="text-xl font-black text-foreground tracking-tighter">Impact Details</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 mb-12">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-[10px] font-black text-muted-foreground uppercase">Date Verified</p>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-[10px] font-black text-muted-foreground uppercase">Field Validator</p>
                    ...
                    <div className="p-6 bg-muted/50 rounded-2xl border border-border mb-8">
                        <p className="text-[10px] font-black text-muted-foreground uppercase mb-2">Ledger Hash</p>
                    ...
                    <button className="w-full h-16 bg-muted text-foreground rounded-2xl font-black text-xs uppercase tracking-widest border border-border hover:bg-muted/80 transition-all flex items-center justify-center gap-3">
                        View Cryptographic Proof <ExternalLink className="w-4 h-4" />
                    </button>
                </div>
                ...
                <div className="bg-muted relative min-h-[400px]">
                    ...
                    <div className="absolute bottom-8 left-8">
                        <p className="text-white text-lg font-black tracking-tight mb-1">On-site Delivery Confirmation</p>
                        <p className="text-white/60 text-xs font-bold uppercase tracking-widest">Captured by Validator</p>
                    </div>
                </div>
            </div>
        </motion.div>
