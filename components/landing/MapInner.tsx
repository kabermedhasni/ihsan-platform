    ...
    >
      ...
      {!loading &&
        districts.map((district, idx) => (
          <Marker
            key={district.id || idx}
            position={[district.lat, district.lng] as [number, number]}
            icon={icon}
          >
