            ...
            <div className="container mx-auto px-4 relative">
                <div className="max-w-4xl mx-auto text-center">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="mb-8 inline-flex p-4 rounded-3xl bg-primary text-white shadow-2xl shadow-primary/50"
                    >
                    ...
                    >
                        Join thousands of donors who place their trust in Ihsan to ensure
                        their giving reaches those in need.
                    </motion.p>
