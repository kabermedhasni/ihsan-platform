...
export const ProofUpload = ({ onUpload, label = "Upload Bank Transfer Screenshot" }: ProofUploadProps) => {
                ...
                {!preview ? (
                    ...
                    >
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-xs text-muted-foreground font-medium mt-1">PNG, JPG or PDF up to 5MB</p>
                        </div>
                    </motion.div>
                ) : (
                    <motion.div
                    ...
                    >
                        ...
                        <div className="p-4 flex items-center justify-between border-t border-border bg-card">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-[10px] font-black text-foreground uppercase truncate max-w-[200px]">{fileName}</span>
                            </div>
                            <span className="text-[10px] font-black text-emerald-500 uppercase tracking-widest bg-emerald-500/10 px-3 py-1 rounded-full">Ready</span>
                        </div>
                    </motion.div>
                )}
            </AnimatePresence>
