                ...
                {need && (
                    <>
                        ...
                        <div className="sticky top-0 bg-card/90 backdrop-blur-md px-6 py-4 flex items-center justify-between border-b border-border z-10">
                            <span className="font-bold text-foreground">Need Details</span>
                            <button
                                onClick={onClose}
                        ...
                        <div className="p-6 flex-1 text-left">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    <div className="text-sm font-medium text-primary mb-1">{getCategoryLabel(need.category)}</div>
                            ...
                            <div className="bg-secondary/50 rounded-2xl p-5 mb-8 space-y-4 border border-border">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <div className="text-sm text-muted-foreground mb-0.5">Verified By</div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <div className="text-sm text-muted-foreground mb-0.5">Beneficiaries</div>
                                        <div className="font-medium text-foreground">{need.beneficiaries} people</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-primary/10 rounded-2xl p-5 mb-6 border border-primary/20">
                                <h3 className="font-bold text-foreground mb-4">Funding Status</h3>
                                ...
                                <div className="flex justify-between items-center mt-4 pt-4 border-t border-primary/20 text-foreground">
                                    <div className="flex flex-col">
                                        <span className="text-xs text-muted-foreground font-medium mb-1">Donors</span>
                                        <span className="font-bold">{need.donors_count || 0}</span>
                                    </div>
                                    <div className="flex flex-col items-end">
                                        <span className="text-xs text-muted-foreground font-medium mb-1">Time Remaining</span>
