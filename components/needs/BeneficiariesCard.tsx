    ...
    return (
        ...
        >
            ...
            <div className="relative z-10">
                <p className="text-primary-foreground/70 text-[10px] font-black uppercase tracking-widest mb-2">{t("impactHeader")}</p>
                <p className="font-black text-4xl mb-1">{t("families", { count })}</p>
                <p className="text-primary-foreground/80 font-medium text-sm">{t("directImpactNote")}</p>
            </div>
