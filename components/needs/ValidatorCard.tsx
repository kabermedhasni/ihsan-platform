                ...
                <div className="flex items-center gap-5 mb-6">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            <p className="font-black text-xl text-foreground">{name || t("verifiedValidator")}</p>
                            <ShieldCheck className="w-5 h-5 text-primary fill-primary/10" />
                        </div>
                        <p className="text-[10px] text-primary font-black uppercase tracking-widest">{t("validatorSub")}</p>
                    </div>
                </div>
