    ...
    >
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div className="max-w-xl">
                ...
                <h3 className="text-3xl font-black mb-4 tracking-tight">Radical Transparency</h3>
                <p className="text-muted-foreground text-lg font-medium leading-relaxed">
                    Every Ouguiya (MRU) is tracked on our public ledger. We ensure that your support goes exactly where it's needed through continuous field verification.
                </p>
            </div>
            <motion.button
                whileHover={{ x: 5 }}
